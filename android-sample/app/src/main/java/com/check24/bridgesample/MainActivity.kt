            ...
            Box(modifier = Modifier.fillMaxSize()) {
                Scaffold(
                    ...
                    NavHost(
                        ...
                        composable("tab1") { WebViewScreen(url = "file:///android_asset/index.html", onBridgeReady = { currentBridge = it }) }
                        composable("tab2") { WebViewScreen(url = "https://portfolio.kibotu.net/", onBridgeReady = { currentBridge = it }) }
                    }
                }
                Box(
                    modifier = Modifier
